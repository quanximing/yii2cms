...
class Bproduct extends Product
{
    ...
    public function getProductCategories($product_id) {
        ...
        $sql =  "SELECT * FROM  product_to_category WHERE product_id = '" . (int)$product_id . "'";
    ...
    public function getProductOptions($product_id) {
        ...
        $product_option_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_option_group_value ogvalue 
		LEFT JOIN `" . DB_PREFIX . "product_option_group` og ON (ogvalue.`product_option_group_id` = og.`product_option_group_id`) 	
		WHERE og.product_id = '" . (int)$product_id . "' AND og.language_id = '" . (int)$this->config->get('config_language_id') . "' 
    ...
    public function getProductOptionValue($product_id) {
        $product_option_value_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_option_value ov 		 
		WHERE ov.product_id = '" . (int)$product_id . "' AND ov.language_id = '" . (int)$this->config->get('config_language_id') . "'");
    ...
    public function getProductOptionGroup($product_id){
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product_option_group WHERE product_id = '" . (int)$product_id . "' AND pd.language_id = '" . (int)$this->config->get('config_language_id') . "'. ORDER BY sort_order ASC");
        return $query->rows;
    }
