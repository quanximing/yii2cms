...
<section class="banner" style="background-image:url(/images/gallery-7.jpg)">
    <div class="container">
        <div class="row">
            <div class="col-md-offset-2 col-md-8 text-center">
...
<section class="cards">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-8">
                <figure>
                    <figcaption style="background-image:url(/images/blog-7.jpg)">
            ...
            <div class="col-md-4">
                <figure>
                    <figcaption style="background-image:url(/images/blog-2.jpg)">
            ...
            <div class="col-md-4">
                <figure>
                    <figcaption style="background-image:url(/images/blog-3.jpg)">
            ...
            <div class="col-md-4">
                <figure>
                    <figcaption style="background-image:url(/images/blog-4.jpg)">
            ...
            <div class="col-md-4">
                <figure>
                    <figcaption style="background-image:url(/images/blog-5.jpg)">
...
<section class="history">
    <div class="container">
        ...
        <div class="row row-block">
            <div class="col-md-5 history-image" style="background-image:url(/images/blog-3.jpg)">
        ...
        <!-- === row item === -->
        <div class="row row-block">
            <div class="col-md-5 history-image" style="background-image:url(/images/blog-4.jpg)">
                <div class="history-title">
        ...
        <!-- === row item === -->
        <div class="row row-block">
            <div class="col-md-5 history-image" style="background-image:url(/images/blog-5.jpg)">
                <div class="history-title">
        ...
        <!-- === row item === -->
        <div class="row row-block">
            <div class="col-md-5 history-image" style="background-image:url(/images/blog-6.jpg)">
                <div class="history-title">
...
<section class="banner" style="background-image:url(/images/gallery-2.jpg)">
    <div class="container">
        <div class="row">
...
<section class="quotes quotes-slider" style="background-image:url(/images/gallery-2.jpg)">
    <div class="container">
        <div class="row">
